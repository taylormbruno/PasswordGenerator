...
document.getElementById("passwordClick").onclick = function passwordClick() {
  ...
  if (howMany < 0 || howMany > 129 || howMany === NaN) {
    ...
    (capLet && lowLet && numChar && specChar) === false &&
    (howMany > 0 || howMany < 129)
  ) {
    $("#passwordFinal").text(
      "Please select the type of characters from the checkbox above."
    );
  } else {
    ...
    var clipPop = document.getElementById("clipboardClick");
